                    ...
                    <Col className="container-home">
                        <div className="mt-lg-5 div-contenido">
                            ...
                            <p className="lead text-muted lh-base text-home">
                                ...
                                compañero peludo perfecto para ti. Ya sea que
                                estés buscando adoptar o necesites servicios
                                para tu mascota actual,{" "}
                                <span className="span-text">
                                    ¡estamos aquí para ayudarte!
                                </span>{" "}
                                Además, si te apasionan los animales y quieres
