...
const Cuidadores = () => {
    ...
    useEffect(() => {
        if (userData?.id && cuidadores.length > 0) {
            const yaRegistrado = cuidadores.some(
                (c) => c.idUsuario === userData.id
            );
    ...
    return (
        <Container sx={{ mt: 4, backgroundColor: "#e0d0b8", borderRadius: 4 }}>
            ...
            <Typography align="center" color="text.secondary" mb={5}>
                Conocé a los cuidadores registrados y encontrá el que mejor se
                adapte a tu mascota.
            </Typography>
                            ...
                            >
                                ...
                                >
                                    <CardMedia
                                        component="img"
                                        src={
                                            cuidador.datosUsuario?.foto ||
                                            "/placeholder.png"
                                        }
                                        alt={
                                            cuidador.datosUsuario
                                                ?.nombreCompleto || "Cuidador"
                                        }
                                        sx={{
                                            maxHeight: 170,
                                            maxWidth: "80%",
                                            // MODIFICAR ACA SI LA FOTO NO SE VE BIEN
                                            objectFit: "cover",
                                            mx: "auto",
                                            my: 2,
                                            mt: 4,
